...
return(
  <div>
    ...
    <form className="absolute w-4/12 bg-black/70 p-12 my-40 mx-auto right-0 left-0 rounded text-white">
...
<div className="relative mb-6">
  ...
  <button className="w-full my-4 p-2 rounded bg-red-600">{isSignInForm?"Sign In":"Sign Up"}</button>
  {isSignInForm && (
    <>
